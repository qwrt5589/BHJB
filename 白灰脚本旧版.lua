...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/qwrt5589/eododo/881e83eed8630261c3935cc6065c7b7a7803c753/%2588555555.lua"))()
...
local Window = OrionLib:MakeWindow({Name = "白灰脚本V1", HidePremium = false, IntroEnabled = false, ConfigFolder = "SB2Mod"})
